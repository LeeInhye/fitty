		...
		<div class="main">
			<form action="" name="vctForm">
				...
				<div class="app-form1">
					...
					<script>
						$(function(){
							let value1 = $("#tb5").children().children().eq(2).children().eq(0).text();
							let value2 = $("#tb5").children().children().eq(2).children().eq(1).text();
							...
							if(!value2){
								$("#tb5").children().children().eq(2).children().eq(1).append("<input type='hidden' name='apprLevel' value='1'>");
							}else{
								$("#tb5").children().children().eq(2).children().eq(1).append("<input type='hidden' name='apprLevel' value='2'>");
								$("#tb5").children().children().eq(1).children().eq(1).prepend('<img src="resources/approval_images/stamp_approved.png" width="35" height="40"><br>');
							}
						})
					</script>
